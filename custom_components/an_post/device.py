...
CONFIGURATION_URL = "https://www.anpost.com"

ATTRIBUTION = "Data provided by An Post"
...
def build_device_info(entry: ConfigEntry) -> DeviceInfo:
    ...
    "An Post (you@example.com) Incoming parcels".
    """
    return DeviceInfo(
        identifiers={(DOMAIN, entry.entry_id)},
        name=f"An Post ({entry.title})",
        manufacturer="An Post",
